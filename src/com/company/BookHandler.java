...
public class BookHandler {
    ...
    public void createNewBook(){
        ...
        listOfAllBooks.add(new Book("Harry Potter and the Chamber of Secrets", "J.K Rowling",
                "Harry Potter countinues his adventures in Hogwarts, but another enemy lurks in the"
                        + " " + "chamber underneeth the school."));
        ...
        listOfAllBooks.add(new Book("Lord of the Rings: Felloship of the Ring", "J.R.R. Tolkien",
                "Frodo, a young hobbit living in peace, encounters a powerful object and" + " " +
                        "got sent out on a great adventure"));
